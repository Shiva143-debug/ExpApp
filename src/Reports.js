                            ...
                            <div className="d-flex flex-column" style={{ width: isMobile ? "100%" : "100%", backgroundColor: isdark ? "black" : "whitesmoke", height: "100%", }}>
                                ...
                                {showTable &&
                                    <div style={{ display: "flex", flexDirection: "column" }}>
                                        <center><h1 style={{ color: isdark ? "white" : "navy" }}> {months[Month - 1]} - {Year} Report</h1></center>
                                        <input type="text" class="form-control mx-5" placeholder="Search..." value={searchTerm} onChange={handleSearchChange} style={{ marginRight: "10px", padding: "5px", width: "50vw" }} />
                                        ...
                                        <div style={{ maxWidth: isMobile ? "100%" : "1000px", overflowX: "auto" }} className="mx-5 ">
                                ...
                                {showItems &&
                                    <div style={{ display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "center" }}>
                                        <div style={{ overflowX: "auto" }}>
                                            <table className="table table-bordered mx-2 mt-5" style={{ width: isMobile ? "400px" : "800px", textAlign: "center" }}>
                                                <thead style={{ color: isdark ? "white" : "navy" }}>
                                                    <th>Category</th>
                                                    <th>Product</th>
                                                    <th>Action</th>
