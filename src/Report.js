                            ...
                            <div className="d-flex flex-column" style={{ width: isMobile ? "100%" : "100%", backgroundColor: isdark ? "black" : "whitesmoke", height: "100%", }}>
                                ...
                                {showTable &&
                                    <div style={{ display: "flex", flexDirection: "column" }}>
                                        ...
                                        {!fromdashboard && <input type="text" class="form-control mx-5" placeholder="Search..." value={searchTerm} onChange={handleSearchChange} style={{ marginRight: "10px", padding: "5px", width: "50vw" }} />}
